                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <a class="btn btn-lg btn-success btn-block" href="{{route('individuosEnHogar',['id'=>$individuo->hogar->id])}}" >
                   ...
                   <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <a class="btn btn-lg btn-primary btn-block" href="{{route('verHogares',['id'=>$individuo->hogar->vivienda->id])}}" >
