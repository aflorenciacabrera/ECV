...
<td>{{$item->caracteristicas->CH08A}}</td>
<td>{{$item->caracteristicas->CH08B}}</td>
<td>{{$item->caracteristicas->CH08C}}</td>
<td>{{$item->caracteristicas->CH08D}}</td>
<td>{{$item->caracteristicas->CH09}}</td>
<td>{{$item->caracteristicas->CH10}}</td>
<td>{{$item->caracteristicas->CH10E}}</td>
<td>{{$item->caracteristicas->CH10M}}</td>
<td>{{$item->caracteristicas->CH10G}}</td>
