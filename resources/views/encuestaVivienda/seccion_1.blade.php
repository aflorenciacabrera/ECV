...
<div class="card-body">
        <div class="form-row">
            <div class="form-group col-md-3">
                    ...
                    <input type="number" min="0" step="1" class="form-control form-control-sm" id="codigo_area" name="codigo_area" aria-describedby="codigo_area" placeholder=" " required>
                    {{-- <small id="codigo_area" class="form-text text-muted"> </small> --}}
            </div>
            <div class="form-group col-md-3">
                    <label for="numero_listado">Nº en el listado:</label>
                    <input type="number" min="0" step="1" class="form-control form-control-sm" id="numero_listado" name="numero_listado"  required>
            </div>
            <div class="form-group col-md-3">
                    <label for="numero_vivienda">Vivienda Nº:</label>
            <input type="number" min="0" step="1" class="form-control form-control-sm" id="numero_vivienda" name="numero_vivienda"  required>
            </div>
            <div class="form-group col-md-3">
                    <label for="numero_semana">Semana Nº:</label>
            <input type="number" min="0" step="1" max="12" class="form-control form-control-sm" id="numero_semana" name="numero_semana"  required>
            </div>
        </div>
        ...
        <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="number" min="0" step="1" class="form-control form-control-sm" id="grupo_rotacion" name="grupo_rotacion"  required>
                </div>
                <div class="form-group col-md-3">
