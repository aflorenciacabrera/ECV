...
<div class="card-body">
        <div class="form-row">
            ...
            <div class="form-group col-md-3">
                    ...
                    <input type="number" min="0" step="1" class="form-control" id="numero_listado" name="numero_listado"  required>
            </div>
            <div class="form-group col-md-3">
                    <label for="numero_vivienda">Vivienda Nº:</label>
            <input type="number" min="0" step="1" class="form-control" id="numero_vivienda" name="numero_vivienda"  required>
            </div>
            <div class="form-group col-md-3">
                    <label for="numero_semana">Semana Nº:</label>
            <input type="number" min="0" step="1" max="12" class="form-control" id="numero_semana" name="numero_semana"  required>
            </div>
        </div>
        ...
        <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="number" min="0" step="1" class="form-control" id="grupo_rotacion" name="grupo_rotacion"  required>
                </div>
                <div class="form-group col-md-3">
                        <label for="telefono_hogar1">Teléfonos:</label>
                    <label for="telefono_hogar1">Hogar 1:</label>
                    <input type="text" class="form-control" id="telefono_hogar1" name="telefono_hogar1"  >
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="telefono_hogar2" name="telefono_hogar2"  >
                </div>
        </div>
