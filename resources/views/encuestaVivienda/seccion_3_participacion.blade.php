...
<div class="card-body">
        <div class="form-row">
            <div class="form-group col-md-4">
                        ...
                        <select class="form-control form-control-sm" name="otra_viv_direc" id="otra_viv_direc"  >
                                <option value=""></option>
                                <option value="1">1. Si</option>
                                <option value="2">2. No</option>
                        </select>
            </div>
            <div class="form-group col-md-4 text-justify">
                    <label for="comparten_gastos ">2. ¿Todas las personas que residen en esta vivienda comparten los gastos de comida y/o de alquiler,
                                ...
                                <select class="form-control form-control-sm" name="comparten_gastos" id="comparten_gastos"  >
                                                <option value=""></option>
                                                <option value="1">1. Si</option>
                                                <option value="2">2. No</option>
                                </select>
                        ...
                        <input type="number" min="0" step="1" class="form-control form-control-sm" id="N_hogar_viv" name="N_hogar_viv" id="N_hogar_viv" placeholder="" >
           ...
           <div class="col-md-4">
            ...
            <div class="form-group form-inline">
                        ...
                        <select class="form-control form-control-sm" name="domestico_cama_adentro" id="domestico_cama_adentro"  >
                                        <option value=""></option>
                                        <option value="1">1. Si</option>
                                        <option value="2">2. No</option>
                        </select>
                        ...
                        <select class="form-control form-control-sm" name="pensionistas" id="pensionistas"  >
                                        <option value=""></option>
                                        <option value="1">1. Si</option>
                                        <option value="2">2. No</option>
                        </select>
