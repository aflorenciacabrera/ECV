...
<div class="card-body">      
                <div class="form-row">
                    <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="4_otra_viv_direc"  >
                    ...
                    <div class="form-group col-md-4">
                            <label for="numero_listado">2. ¿Todas las personas que residen en esta vivienda comparten los gastos de comida y/o de alquiler,
                                        ...
                                        <select class="form-control" name="4_comparten_gastos"  >
                                                        <option value="1">Si</option>
                                                        <option value="2" >No</option>             
                                        </select>
                    </div>
                    <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="" name="4_N_hogar_viv" placeholder="" >
                ...
                <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="4_domestico_cama_adentro"  >
                                                <option value="1">Si</option>
                                                <option value="2" >No</option>             
                                </select>
                        </div>
                        <div class="form-group col-md-4">
                                ...
                                <select class="form-control" name="4_pensionistas"  >
                                                <option value="1">Si</option>
                                                <option value="2" >No</option>             
                                </select>
