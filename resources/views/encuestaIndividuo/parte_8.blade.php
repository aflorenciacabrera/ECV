...
<select name="PP08A" id="PP08A" class="form-control form-control-sm">
    <option value=""></option>
    ...
    <div class="form-group form-inline">
            ...
            <select name="PP08B" id="PP08B" class="form-control form-control-sm">
                <option value=""></option>
    ...
    <div class="form-group form-inline">
        ...
        <input type="number" class="form-control form-control-sm" name="PP08C" id="PP08C">
    </div>
    <label>8d. Cuanto cobró por ese mes&nbsp;</label>
        <div class="form-group form-inline">
            <label for="PP08D2">&nbsp;&nbsp;&nbsp;Pesos&nbsp;<label>
            <input type="number" class="form-control form-control-sm" name="PP08D2" id="PP08D2">
        </div>
        <div class="form-group form-inline">
            <label for="PP08D3">&nbsp;&nbsp;&nbsp;Bonos&nbsp;<label>
            <input type="number" class="form-control form-control-sm" name="PP08D3" id="PP08D3">
        </div>
        <div class="form-group form-inline">
            <label for="PP08D4">&nbsp;&nbsp;&nbsp;Tickets&nbsp;<label>
            <input type="number" class="form-control form-control-sm" name="PP08D4" id="PP08D4">
        </div>
 <div class="form-group form-inline">
<label for="PP08E">8e. Cobró &nbsp;</label>
<select name="PP08E" id="PP08E" class="form-control form-control-sm">
    <option value=""></option>
...
{{-- 8.f --}}
    ...
    <div class="form-group form-inline">
        ...
        <label for="PP08F1" >&nbsp;&nbsp;&nbsp;Comisión por  venta/producción <label>
            <input type="number" class="form-control form-control-sm" name="PP08F1" id="PP08F1">

    </div>
    <div class="form-group form-inline">
        <label for="PP08F2" >&nbsp;&nbsp;&nbsp;Propinas<label>
            <input type="number" class="form-control form-control-sm" name="PP08F2" id="PP08F2">
 ...
 <div class="form-group form-inline">
    ...
    <select name="PP08G" id="PP08G" class="form-control form-control-sm">
        <option value=""></option>
...
<select name="PP08I" id="PP08I" class="form-control form-control-sm">
    <option value=""></option>
...
{{--  --}}
    ...
    <div class="form-group form-inline">
        ...
        <input type="number" class="form-control form-control-sm" name="PP08J1" id="PP08J1">
    </div>
    <div class="form-group form-inline">
        <label for="PP08J2" >&nbsp;&nbsp;&nbsp;Monto otras bonificaciones no habituales &nbsp;<label>
        <input type="number" class="form-control form-control-sm" name="PP08J2" id="PP08J2">
    </div>
    <div class="form-group form-inline">
        <label for="PP08J3" >&nbsp;&nbsp;&nbsp;Monto retroactivos&nbsp;<label>
        <input type="number" class="form-control form-control-sm" name="PP08J3" id="PP08J3">
    </div>


 <div class="form-group form-inline">
<label for="PP08K">8k. Su patron o empleador es </label>
<select name="PP08K" id="PP08K" class="form-control form-control-sm">
    <option value=""></option>
