                    ...
                    <small class="form-text text-muted"> (la que habitualmente le lleva más horas)</small>
                     <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                        ...
                                        <td>  <input type="number"  min=-9  max=24  class="form-control PP03E" disabled onchange="update_parte_3()" name="PP03E_domigo"> </td>
                                        </tr>
                                        <tr>
                                        <th scope="row">lunes?    </th>
                                        <td>  <input type="number"  min=-9  max=24  class="form-control PP03E"  disabled onchange="update_parte_3()" name="PP03E_lunes"></td>
                                        </tr>
                                        <tr>
                                        <th scope="row">martes? </th>
                                        <td>  <input type="number"  min=-9  max=24  class="form-control PP03E"  disabled onchange="update_parte_3()" name="PP03E_martes"></td>
                                        </tr>
                                        <tr>
                                        <th scope="row">miercoles?    </th>
                                        <td>  <input type="number"  min=-9  max=24  class="form-control PP03E"  disabled onchange="update_parte_3()" name="PP03E_miercoles"> </td>
                                        </tr>
                                        <tr>
                                        <th scope="row">jueves?   </th>
                                        <td>  <input type="number"  min=-9  max=24  class="form-control PP03E"  disabled onchange="update_parte_3()" name="PP03E_jueves"> </td>
                                        </tr>
                                         <tr>
                                        <th scope="row">viernes? </th>
                                        <td>  <input type="number"  min=-9  max=24  class="form-control PP03E" disabled onchange="update_parte_3()" name="PP03E_viernes"> </td>
                                        </tr>
                                         <tr>
                                        <th scope="row">sabado?   </th>
                                        <td>  <input type="number"  min=-9  max=24 class="form-control PP03E" disabled onchange="update_parte_3()" name="PP03E_sabado"></td>
                                        </tr>
                                        <tr>
                                        <th scope="row">Total de horas  </th>
                                        <td>  <input type="number"  min=-9 class="form-control PP03E" max="999"  disabled onchange="update_parte_3()" name="PP03E" id="PP03E"></td>
                                        </tr>
                                </tbody>
                        </table>
            </div>
             <div class="form-group col-md-6">
                    ...
                    <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                        <tr>
                                        <th scope="row">Domingo? </th>
                                        <td>  <input type="number"  min=-9 max=24 class="form-control PP03F" disabled onchange="update_parte_3()" name="PP03F_domingo"> </td>
                                        </tr>
                                        <tr>
                                        <th scope="row">lunes?    </th>
                                        <td>  <input type="number"  min=-9 max=24 class="form-control PP03F"  disabled onchange="update_parte_3()" name="PP03F_lunes"></td>
                                        </tr>
                                        <tr>
                                        <th scope="row">martes? </th>
                                        <td>  <input type="number"  min=-9 max=24 class="form-control PP03F"  disabled onchange="update_parte_3()" name="PP03F_martes"></td>
                                        </tr>
                                        <tr>
                                        <th scope="row">miercoles?    </th>
                                        <td>  <input type="number"  min=-9 max=24 class="form-control PP03F"  disabled onchange="update_parte_3()" name="PP03F_miercoles"> </td>
                                        </tr>
                                        <tr>
                                        <th scope="row">jueves?   </th>
                                        <td>  <input type="number"  min=-9 max=24 class="form-control PP03F"  disabled onchange="update_parte_3()" name="PP03F_jueves"> </td>
                                        </tr>
                                         <tr>
                                        <th scope="row">viernes? </th>
                                        <td>  <input type="number"  min=-9 max=24 class="form-control PP03F" disabled onchange="update_parte_3()" name="PP03F_viernes"> </td>
                                        </tr>
                                         <tr>
                                        <th scope="row">sabado?   </th>
                                        <td>  <input type="number"  min=-9 max=24 class="form-control PP03F" disabled onchange="update_parte_3()" name="PP03F_sabado"></td>
                                        </tr>
                                        <tr>
                                        <th scope="row">Total de horas  </th>
