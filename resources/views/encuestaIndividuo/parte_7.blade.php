            ...
            <div class="form-group col-md-6">
                    <label for="PP07A">7a. ¿Cuánto tiempo hace que está trabajando en ese empleo en forma continua?</label>
                     <select class="form-control" name="PP07A" id="PP07A" >
                                ...
                                <option value="2" >1 a 3 meses</option>  
                                <option value="3" >Más de 3 meses y hasta 6 meses</option>  
                                <option value="4" >Más de 6 meses y hasta 12 meses</option>  
                                <option value="5" >Más de 1 año y hasta 5 años</option>  
           ...
           <div class="form-group col-md-6">
                    <label for="PP07C">7c. ¿Ese empleo tiene tiempo de finalización?</label>
                     <select class="form-control" name="PP07C" id="PP07C" >
                                <option value=" "> </option>
                                <option value="1">Si (incluye changa, trabajo transitorio, por tarea u obra, suplencia, etc.)</option>
                                <option value="2" >No (inlcuye permanente, fijo, estable, de planta)</option>    
                                <option value="9" >Ns/Nr</option>            
                        </select>
             ...
             <div class="form-group col-md-6">
                    <label for="PP07D">7d. ¿Por cuánto tiempo es ese trabajo?</label>
                     <select class="form-control" name="PP07D" id="PP07D"  >
                                <option value=" "> </option>
                                <option value="1">Solo fue esa vez/sólo cuando lo llaman</option>
                                <option value="2" >Hasta 3 meses</option>
                                <option value="3">Más de 3 meses y hasta 6 meses</option>    
                                <option value="4">Más de 6 meses y hasta 12 meses</option>
                                <option value="5">Más de 1 año</option>
                                <option value="9">Ns/Nr</option>
                ...
                <div class="form-group col-md-6">
                    <label for="PP07E">7e. ¿Ese trabajo es…</label>
                     <select class="form-control" name="PP07E" id="PP07E"  >
                                <option value=" "> </option>
                                <option value="1">Un plan de empleo?</option>
                                <option value="2" >Un período de prueba</option>
                                <option value="3" >Una beca/pasantía/aprendizaje?</option>
                                <option value="4" >Ninguno de estos</option>          
                        </select>
             ...
             <div class="form-group col-md-6">
                  <label for="PP07J ">7j. ¿El turno habitual de trabajo es…</label>
                        <select class="form-control" name="PP07J" id="PP07J" >
                                <option value=" "> </option>
                                <option value="1">… de día? (mañana/tarde)</option>
                                <option value="2" >… de noche?</option>   
                                <option value="3" >… de otro tipo? (rotativo, día y noche,guardias con franco)</option>   
                        </select>
            </div>           
             <div class="form-group col-md-6">
                   <label for="PP07K ">7k. ¿Cuándo cobra…</label>
                    <select class="form-control" name="PP07K" id="PP07K" >
                                <option value=" "> </option>
                                <option value="1">le dan recibo con sello/membrete/firma del empleador?</option>
                                <option value="2" >le dan un papel/recibo sin nada?</option>  
                                <option value="3" >entrega una factura?</option>   
                                <option value="4" >no le dan ni entrega nada?</option>  
                                <option value="5" >no cobra, es trabajador sin pago/ad-honorem</option>   
                        </select>
            </div> 
        </div>                    
</div>
