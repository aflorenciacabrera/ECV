<div class="card-body">
    ...
    <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control form-control-sm" name="III1_1"  >
                        <option value=""></option>
                    ...
                    <select class="form-control form-control-sm" name="III1_2"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
    ...
    <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control form-control-sm" name="III2"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
