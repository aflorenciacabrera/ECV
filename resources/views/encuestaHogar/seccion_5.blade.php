...
<div class="form-group col-md-10">
        ...
        <div class="form-row ">
            ...
            <div class="col-md-2" >
                <select class="form-control form-control-sm" name="V1"  >
                    <option value=""></option>
        ...
        <div class="form-row ">
            ...
            <div class="col-md-2" >
                <select class="form-control form-control-sm" name="V2"  >
                    <option value=""></option>
                    <option value="1">1. Si</option>
                    <option value="2">2. No</option>
                </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V3"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V4"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V5"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
            ...
            <div class="col-md-2" >
                <select class="form-control form-control-sm" name="V6"  >
                    <option value=""></option>
                    <option value="1">1. Si</option>
                    <option value="2">2. No</option>
                </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V7"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V8"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V9"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V10"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V11"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V12"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V13"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V14"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V15"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V16"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V17"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                ...
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V18"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
        ...
        <div class="form-row ">
                <div class="col-md-10">
                    <label for="numero_semana">19.1… Alguno de los niños (menores de 10 años) ayuda con algún dinero
                            …trabajando?
                            </label>
                    <label for="numero_semana">19.2… Alguno de los niños (menores de 10 años) ayuda con algún dinero
                                    …pidiendo?</label>
                </div>
                <div class="col-md-2" >
                    <select class="form-control form-control-sm" name="V19_A"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
                    <select class="form-control form-control-sm" name="V19_B"  >
                        <option value=""></option>
                        <option value="1">1. Si</option>
                        <option value="2">2. No</option>
                    </select>
