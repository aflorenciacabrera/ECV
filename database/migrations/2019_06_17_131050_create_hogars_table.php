...
class CreateHogarsTable extends Migration
{
    ...
    public function up()
    {
        ...
        // I. Identificación
            ...
            $table->text('ano4')->nullable()->nullable();
        ...
        // VI. Ingreso no laborales
            ...
            $table->text('V22_M')->nullable();
                // $table->text('V22_M_1')->nullable();
                // $table->text('V22_M_2')->nullable();
                // $table->text('V22_M_3')->nullable();
                // $table->text('V22_M_4')->nullable();
                // $table->text('V22_M_5')->nullable();
            ...
            $table->text('V19_AM')->nullable();
                // $table->text('V19_AM_1')->nullable();
                // $table->text('V19_AM_2')->nullable();
                // $table->text('V19_AM_3')->nullable();
                // $table->text('V19_AM_4')->nullable();
                // $table->text('V19_AM_5')->nullable();
